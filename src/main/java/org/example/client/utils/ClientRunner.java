...
import org.example.client.api.ContactClient;

import java.util.Scanner;

public class ClientRunner {
    private final Scanner scanner = new Scanner(System.in);
    private static final String GET_CONTACT_INFO_KEY = "get";
    ...
    private String makeRequest() {
        System.out.print(">> To get contact info, input '" + GET_CONTACT_INFO_KEY + "' or " +
